    ...
    <body>
        ...
        <script>
            ...
            $(document).ready(function(){
                ...
                mymap = L.map('mapdiv', {center:[51.74, 0.46], zoom:9, attributionControl:false});
           ...
           function processClientLinears(json, lyr) {
            ...
            function refreshDist() {
                    $.ajax({
                        ...
                        data: { tbl: 'dist_eastern', flds: 'distid, postdist, postarea, x, y' , where:"postarea='CM'"},
                        type: 'GET',
            ...
            function refreshSectors() {
                    $.ajax({
                        url: 'load_allpostcodes.php',
                        data: { tbl:'sect_chelmsford', flds: 'sectid, rmsect, postdist, postarea, x, y' },
                        type: 'GET',
                        success: function (response) {
                            arProjectIDs = [];
            ...
            function filterEagle(json) {
             ...
             function refreshEagles(){
                $.ajax({url:'load_allpostcodes.php',
                    data: {tbl:'chelmsfordcm', flds:'field_1, field_2, field_3, field_4, field_5'},
                    type: 'GET',
                    success: function(response){
                        arEagleIDs=[];
