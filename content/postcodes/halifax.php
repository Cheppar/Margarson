           ...
           function processClientLinears(json, lyr) {
            ...
            function refreshDist() {
                    $.ajax({
                        ...
                        data: { tbl: 'dist_yorkshirehumber', flds: 'distid, postdist, postarea, x, y' , where:"postarea='HX'"},
                        type: 'GET',
            ...
            function refreshSectors() {
                    $.ajax({
                        url: 'load_allpostcodes.php',
                        data: { tbl:'sect_halifax', flds: 'sectid, rmsect, postdist, postarea, x, y' },
                        type: 'GET',
                        success: function (response) {
                            arProjectIDs = [];
				...
				function refreshEagles() {
					$.ajax({
						url: 'load_allpostcodes.php',
						data: { tbl:'halifaxhx', flds:'id, field_1, field_2, field_3, field_4, field_5' },
						type: 'GET',
						success: function (response) {
							arEagleIDs = [];
