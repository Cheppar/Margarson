...
<html lang="en">
	<head>
		<meta charset="UTF-8" />
		<title>Hemel-hempstead HH</title>
           ...
           function processClientLinears(json, lyr) {
            ...
            function refreshDist() {
                    $.ajax({
                        ...
                        data: { tbl: 'dist_seastengland', flds: 'distid, postdist, postarea, x, y' , where:"postarea='HP'"},
                        type: 'GET',
            ...
            function refreshSectors() {
                    $.ajax({
                        url: 'load_allpostcodes.php',
                        data: { tbl:'sect_hempstead', flds: 'sectid, rmsect, postdist, postarea, x, y' },
                        type: 'GET',
                        success: function (response) {
                            arProjectIDs = [];
				...
				function refreshEagles() {
					$.ajax({
						url: 'load_allpostcodes.php',
						data: { tbl:'hempstead', flds: 'id, field_1, field_2, field_3, field_4, field_5' },
						type: 'GET',
						success: function (response) {
							arEagleIDs = [];
