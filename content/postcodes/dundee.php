           ...
           function processClientLinears(json, lyr) {
            ...
            function refreshDist() {
                    $.ajax({
                        ...
                        data: { tbl: 'dist_scotland', flds: 'distid, postdist, postarea, x, y' , where:"postarea='DD'"},
                        type: 'GET',
            ...
            function refreshSectors() {
                    $.ajax({
                        url: 'load_allpostcodes.php',
                        data: { tbl:'sect_dundee', flds: 'sectid, strsect, rmsect, postdist, postarea, x, y' },
                        type: 'GET',
                        success: function (response) {
                            arProjectIDs = [];
            ...
            function filterEagle(json) {
             ...
             function refreshEagles(){
                $.ajax({url:'load_allpostcodes.php',
                    data: {tbl:'dundeedd', flds:'id, field_1, field_2, field_3, field_4, field_5'},
                    type: 'GET',
                    success: function(response){
                        arEagleIDs=[];
