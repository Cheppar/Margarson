    ...
    <body>
        ...
        <script>
            ...
            $(document).ready(function(){
                ...
                mymap = L.map('mapdiv', {center:[51.46, -2.58], zoom:10, attributionControl:false});
           ...
           function processClientLinears(json, lyr) {
            ...
            function refreshDist() {
                    $.ajax({
                        ...
                        data: { tbl: 'dist_swengland', flds: 'distid, postdist, postarea, x, y' , where:"postarea='BS'"},
                        type: 'GET',
            ...
            function refreshSectors() {
                    $.ajax({
                        url: 'load_allpostcodes.php',
                        data: { tbl:'sect_bristol', flds: 'sectid, rmsect, postdist, postarea, x, y' },
                        type: 'GET',
                        success: function (response) {
                            arProjectIDs = [];
            ...
            function filterEagle(json) {
             ...
             function refreshEagles(){
                $.ajax({url:'load_allpostcodes.php',
                    data: {tbl:'bristolbs', flds:'field_1, field_2, field_3, field_4, field_5'},
                    type: 'GET',
                    success: function(response){
                        arEagleIDs=[];
