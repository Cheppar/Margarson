           ...
           function processClientLinears(json, lyr) {
            ...
            function refreshDist() {
                    $.ajax({
                        ...
                        data: { tbl: 'dist_northwesteuro', flds: 'distid, postdist, postarea, x, y' , where:"postarea='CH'"},
                        type: 'GET',
            ...
            function processSectorLinears(json, lyr) {
             ...
             arProjectIDs.push(att.rmsect.toString());
            }

            function refreshSectors() {
                    $.ajax({
                        url: 'load_allpostcodes.php',
                        data: { tbl:'sect_chester', flds: 'sectid, strsect, rmsect, postdist, postarea, x, y' },
                        type: 'GET',
                        success: function (response) {
                            arProjectIDs = [];
