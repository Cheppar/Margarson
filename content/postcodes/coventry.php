       ...
       <div id="side-bar" class="col-md-3">
        ...
        <script>
            ...
            $(document).ready(function(){
                ...
                mymap = L.map('mapdiv', {center:[52.41, -1.52], zoom:9, attributionControl:false});
           ...
           function processClientLinears(json, lyr) {
            ...
            function refreshDist() {
                    $.ajax({
                        ...
                        data: { tbl: 'dist_westmidlands', flds: 'distid, postdist, postarea, x, y' , where:"postarea='CV'"},
                        type: 'GET',
            ...
            function refreshSectors() {
                    $.ajax({
                        url: 'load_allpostcodes.php',
                        data: { tbl:'sect_coventry', flds: 'sectid, rmsect, postdist, postarea, x, y' },
                        type: 'GET',
                        success: function (response) {
                            arProjectIDs = [];
