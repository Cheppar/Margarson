    ...
    <body>
        ...
        <script>
           ...
           function processClientLinears(json, lyr) {
             ...
             lyr.bindPopup("<h4>District: "+att.rmsect+"</h4>").addTo(mymap);
            ...
            function refreshDist() {
                    $.ajax({
                        ...
                        data: { tbl: 'dist_scotland', flds: 'distid, postdist, postarea, x, y' , where:"postarea='AB'"},
                        type: 'GET',
            ...
            function refreshSectors() {
                    $.ajax({
                        url: 'load_allpostcodes.php',
                        data: { tbl:'sect_aberdeen', flds: 'sectid, strsect, rmsect, postdist, postarea, x, y' },
                        type: 'GET',
                        success: function (response) {
                            arProjectIDs = [];
            ...
            function filterEagle(json) {
             ...
             function refreshEagles(){
                $.ajax({url:'load_allpostcodes.php',
                    data: {tbl:'aberdeenab', flds:'id, field_1, field_2, field_3, field_4, field_5'},
                    type: 'GET',
                    success: function(response){
                        arEagleIDs=[];
