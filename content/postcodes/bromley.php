       ...
       <div id="side-bar" class="col-md-3">
        ...
        <script>
            ...
            $(document).ready(function(){
                ...
                mymap = L.map('mapdiv', {center:[51.41, 0.01], zoom:11, attributionControl:false});
           ...
           function processClientLinears(json, lyr) {
            ...
            function refreshDist() {
                    $.ajax({
                        ...
                        data: { tbl: 'dist_seastengland', flds: 'distid, postdist, postarea, x, y' , where:"postarea='BR'"},
                        type: 'GET',
            ...
            function refreshSectors() {
                    $.ajax({
                        url: 'load_allpostcodes.php',
                        data: { tbl:'sect_bromley', flds: 'sectid, rmsect, postdist, postarea, x, y' },
                        type: 'GET',
                        success: function (response) {
                            arProjectIDs = [];
